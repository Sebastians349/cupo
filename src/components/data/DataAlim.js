export const DataAlim = [
  {
    id: 1,
    logo: '/assets/img/4.png',
    nombre: 'Supermercado',
    descripcion: 'Almacen de...',
    categoria: 'Alimentos',
    oferta: '2 x 1 en galletas de arroz ',
  ...
  },
  {
    ...
    nombre: 'Dietetica',
    descripcion: 'Dietetica',
    categoria: 'Alimentos',
    oferta: '50% OFf primera compra en ',
    ubicacion: 'Romulo Naon 2402',
    detalle: 'solo efectivo/debito',
    mail: 'tu_mail@gmail.com',
    fb: 'markete',
    ig: 'localete',
    tw: 'potus',
